...
public class RedisShardedPool {
    ...
    private static String redis1Ip = props.getProperty("redis1.ip");
    private static Integer redis1Port = Integer.valueOf(props.getProperty("redis1.port"));
    private static String redis2Ip = props.getProperty("redis2.ip");
    private static Integer redis2Port = Integer.valueOf(props.getProperty("redis2.port"));
